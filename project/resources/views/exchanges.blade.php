...
@section('content')
    ...
    <h1 class="section-header">Список криптобирж</h1>
        ...
        <table class="sort-table ta ta-table-responsive-full ">
            ...
            @for($i=0;$i<20;$i++)
                <tr class="ref-coin" data-url-sn="{{$i}}">
                    ...
                    <td><a target="_blank" class="href-ref" data-type="url" href="">
                            <button>Открыть</button>
                        </a>
                    <td><img class="eoc-logo-list img-ref" data-type="imageUrl" src="">
...
@section('footerScripts')
    ...
    <script src="{{ asset('js/exchanges.js?v=0')}}"></script>
